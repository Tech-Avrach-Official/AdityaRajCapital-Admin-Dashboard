...
import { loginRM, logoutRM, checkAuthStatus } from "./authThunks"
...
const authSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(loginRM.fulfilled, (state, action) => {
        state.loading = false
      ...
      .addCase(loginRM.rejected, (state, action) => {
        state.loading = false
    ...
    // ============ Logout ============
    builder
      .addCase(logoutRM.fulfilled, (state) => {
        state.isAuthenticated = false
        state.token = null
        state.adminId = null
        state.user = null
