...
const RMSidebar = ({ onMobileClose }) => {
  ...
  const isActiveRoute = (path) => {
    ...
    if (path === "/rm") {
      return location.pathname === "/rm" || location.pathname === "/rm/"
    }
              ...
              <div key={item.id}>
                {hasSubmenu ? (
                  ...
                  <NavLink
                    ...
                    end={item.path === "/rm"} // Use 'end' prop for exact matching on dashboard
                    className={({ isActive }) => {
                      const active = item.path === "/rm" 
                        ? (location.pathname === "/rm" || location.pathname === "/rm/")
                        : isActive
                      return cn(
