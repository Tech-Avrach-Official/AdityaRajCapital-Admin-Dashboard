...
const PartnerSidebar = ({ onMobileClose }) => {
  ...
  const menuItems = [
    ...
    {
      id: "Commissions-History",
      name: "Commissions History",
      icon: Percent,
      path: "/partner/commissions-history",
    },
    {
      id: "profile",
      name: "Profile",
        ...
        {sidebarOpen ? (
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 leading-tight">Partner Panel</p>
            </div>
          </div>
        ) : (
