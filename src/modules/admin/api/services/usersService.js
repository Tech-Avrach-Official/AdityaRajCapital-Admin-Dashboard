...
export const usersService = {
  ...
  async getRMs(params = {}) {
    ...
    const response = await adminApiClient.get(endpoints.rm.list, { params })
    return {
  ...
  async getRM(id) {
    ...
    const response = await adminApiClient.get(endpoints.rm.get(id))
  ...
  async initiateRMSignup(formData) {
    ...
    const response = await adminApiClient.post(endpoints.rm.initiate, formData, {
  ...
  async verifyMobileOtp(signupRequestId, otp) {
    ...
    const response = await adminApiClient.post(endpoints.rm.verifyMobileOtp, {
      signup_request_id: signupRequestId,
      mobile_otp: otp,
    })
    return response.data
  ...
  async verifyEmailOtp(signupRequestId, otp) {
    ...
    const response = await adminApiClient.post(endpoints.rm.verifyEmailOtp, {
      signup_request_id: signupRequestId,
      email_otp: otp,
    })
    return response.data
  ...
  async completeRMSignup(signupRequestId) {
    ...
    const response = await adminApiClient.post(endpoints.rm.complete, {
      signup_request_id: signupRequestId,
    })
    return response.data
  },
  ...
  async resendMobileOtp(signupRequestId) {
    ...
    const response = await adminApiClient.post(endpoints.rm.resendMobileOtp, {
      signup_request_id: signupRequestId,
    })
    return response.data
  },
  ...
  async resendEmailOtp(signupRequestId) {
    ...
    const response = await adminApiClient.post(endpoints.rm.resendEmailOtp, {
      signup_request_id: signupRequestId,
    })
    return response.data
  },
  ...
  async getSignupStatus(signupRequestId) {
    ...
    const response = await adminApiClient.get(endpoints.rm.signupStatus(signupRequestId))
    return response.data
  },
  ...
  async createRM(formData) {
    ...
    const response = await adminApiClient.post(endpoints.rm.create, formData, {
      headers: { "Content-Type": "multipart/form-data" },
    })
    return response.data
  },
  ...
  async updateRM(id, rmData) {
    ...
    const response = await adminApiClient.put(endpoints.rm.update(id), rmData)
    return response.data
  },
  ...
  async deleteRM(id) {
    ...
    const response = await adminApiClient.delete(endpoints.rm.delete(id))
    return response.data
  },
  ...
  async validateRMCode(code) {
    ...
    const response = await adminApiClient.get(endpoints.rm.validateCode(code))
    return response.data
  },
  ...
  async getRMPartners(rmId) {
    ...
    const response = await adminApiClient.get(endpoints.rm.partners(rmId))
    return response.data
  },

  async getRMInvestors(rmId, params = { limit: 50, offset: 0 }) {
    const response = await adminApiClient.get(endpoints.rm.investors(rmId), { params })
  ...
  async getRMVisits(rmId, params = { limit: 50, offset: 0, visit_type: undefined }) {
    ...
    const response = await adminApiClient.get(endpoints.rm.visits(rmId), { params: q })
    return response.data?.data || { visits: [], visits_count: 0, limit: 50, offset: 0 }
  },

  async getRMCommissionSummary(rmId) {
    const response = await adminApiClient.get(endpoints.rm.commissionSummary(rmId))
    return response.data?.data || null
  },

  async getRMCommissions(rmId, params = { limit: 50, offset: 0 }) {
    const response = await adminApiClient.get(endpoints.rm.commissions(rmId), { params })
  ...
  async getPartners(params = {}) {
    ...
    const response = await adminApiClient.get(endpoints.partners.list, { params })
    return {
  ...
  async getPartner(id) {
    ...
    const response = await adminApiClient.get(endpoints.partners.get(id))
    return response.data?.data ?? null
  },
  ...
  async changePartnerRM(partnerId, rmId) {
    ...
    const response = await adminApiClient.patch(endpoints.partners.changeRM(partnerId), {
      rm_id: rmId,
    })
    return response.data
  },
  ...
  async getInvestors(params = {}) {
    ...
    const response = await adminApiClient.get(endpoints.users.investors, { params: paramsToSend })
  ...
  async getInvestor(id) {
    ...
    try {
      const response = await adminApiClient.get(endpoints.admin.getInvestor(id))
  ...
  async getInvestorKycDocuments(investorId) {
    const response = await adminApiClient.get(endpoints.admin.investorKycDocuments(investorId))
    const data = response.data?.data ?? response.data
    return data?.documents ?? []
  },

  async getInvestorBankAccounts(investorId) {
    const response = await adminApiClient.get(endpoints.admin.investorBankAccounts(investorId))
    const data = response.data?.data ?? response.data
  ...
  async getInvestorNominees(investorId) {
    const response = await adminApiClient.get(endpoints.admin.investorNominees(investorId))
    const data = response.data?.data ?? response.data
  ...
  async getInvestorPurchases(investorId, params = {}) {
    const response = await adminApiClient.get(endpoints.admin.investorPurchases(investorId), { params })
    const data = response.data?.data ?? response.data
