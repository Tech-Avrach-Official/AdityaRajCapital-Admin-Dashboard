...
export const financialService = {
  ...
  async getInvestmentsList(params = {}) {
    ...
    const response = await adminApiClient.get(endpoints.investments.list, { params: apiParams })
  ...
  async getInvestments(params = {}) {
    ...
    try {
      ...
      const response = await adminApiClient.get(endpoints.purchases.list, { params: apiParams })
  ...
  async getPayoutsList(params = {}) {
    ...
    const response = await adminApiClient.get(endpoints.payouts.list, { params: apiParams })
    const data = response.data?.data ?? response.data
    return {
  ...
  async getCommissionsList(params = {}) {
    ...
    const response = await adminApiClient.get(endpoints.commissions.list, { params: apiParams })
    const data = response.data?.data ?? response.data
    return {
