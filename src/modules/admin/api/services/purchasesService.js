...
export const purchasesService = {
  ...
  async getPendingVerifications(params = {}) {
    ...
    const response = await adminApiClient.get(endpoints.purchases.pendingVerification, { params })
  ...
  async getPurchase(purchaseId) {
    const response = await adminApiClient.get(endpoints.purchases.get(purchaseId))
  ...
  async getSignedDeedUrl(purchaseId) {
    const response = await adminApiClient.get(endpoints.purchases.signedDeedUrl(purchaseId))
    const data = response.data?.data ?? response.data
  ...
  async getInstallments(purchaseId) {
    const response = await adminApiClient.get(endpoints.purchases.installments(purchaseId))
    const data = response.data?.data ?? response.data
  ...
  async getPaymentProofUrl(purchaseId) {
    ...
    const response = await adminApiClient.get(endpoints.purchases.paymentProofUrl(purchaseId))
  ...
  async verifyPayment(purchaseId, { cheque_number } = {}) {
    ...
    const response = await adminApiClient.post(endpoints.purchases.verifyPayment(purchaseId), {
      cheque_number: trimmedCheque,
    })
  ...
  async rejectPayment(purchaseId, { reason } = {}) {
    ...
    const response = await adminApiClient.post(endpoints.purchases.rejectPayment(purchaseId), {
      reason,
    })
    return response.data
  },
