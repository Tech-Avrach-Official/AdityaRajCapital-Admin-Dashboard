...
import { kycService } from "@/modules/admin/api/services/kycService"
...
export const fetchKYCList = createAsyncThunk(
  ...
  async (params = {}, { rejectWithValue, getState }) => {
    try {
      ...
      const currentFilters = state.admin.kyc.filters
      const currentPagination = state.admin.kyc.pagination
