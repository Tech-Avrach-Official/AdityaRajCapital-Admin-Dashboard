...
const UploadCommissionPage = () => {
  ...
  const handleUpload = async () => {
    ...
    setError("")
    try {
      // TODO: Replace with commission upload API when available
      await new Promise((r) => setTimeout(r, 800))
      toast.success("Commission file uploaded successfully. Processing may take a moment.")
      setFile(null)
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      <nav className="flex items-center gap-2 text-sm text-muted-foreground">
        <Link to="/admin/financial/commissions" className="hover:text-foreground transition-colors">
          Commissions
        </Link>
        <span>/</span>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <PageHeader
          title="Upload Commission File"
          description="Upload your commission payout or bank statement PDF to process commission payouts."
        />
        <Button variant="ghost" size="sm" asChild>
          <Link to="/admin/financial/commissions" className="gap-2">
        ...
        <CardContent className="p-6">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Button variant="outline" asChild>
              <Link to="/admin/financial/commissions">Cancel</Link>
            </Button>
          </div>
        </CardContent>
      </Card>
...
export default UploadCommissionPage
