...
const LEGACY_ENABLED =
  import.meta.env.VITE_ENABLE_LEGACY_ADMIN_LOGIN === "true"
...
const LoginPage = () => {
  ...
  const { login, loginLegacy, isAuthenticated, loading, error, clearError } =
    useAuth()
  ...
  const validateForm = () => {
    const errors = {}
    if (useLegacy) {
      if (!formData.admin_id.trim()) errors.admin_id = "Admin ID is required"
    } else {
        ...
        <Card className="shadow-lg">
          <CardHeader className="text-center pb-4">
            <CardTitle className="text-xl">
              {useLegacy ? "Legacy Admin Login" : "Staff Login"}
            </CardTitle>
            <CardDescription>
              {useLegacy
                ? "Sign in with your legacy admin ID."
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-10 ${
                        formErrors.admin_id ? "border-destructive" : ""
                      }`}
                      disabled={loading}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      name="email"
                      type="email"
                      placeholder="you@adityarajcapital.com"
              ...
              {LEGACY_ENABLED && (
                ...
                >
                  {useLegacy
                    ? "Use staff email login instead"
                    : "Use legacy admin ID login"}
                </button>
              )}
            </form>
          </CardContent>
